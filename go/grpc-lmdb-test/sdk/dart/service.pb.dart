...
class MathServiceApi {
  ...
  $async.Future<Response> add($pb.ClientContext ctx, Request request) {
    var emptyResponse = Response();
    return _client.invoke<Response>(ctx, 'MathService', 'Add', request, emptyResponse);
  }
  $async.Future<Response> multiply($pb.ClientContext ctx, Request request) {
    var emptyResponse = Response();
    return _client.invoke<Response>(ctx, 'MathService', 'Multiply', request, emptyResponse);
  }
}
