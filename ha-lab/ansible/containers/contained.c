...
/* 
    contained.c.
    Copyright (C) 2016 Elizabeth Dixon
...
//	}
    ...
    snprintf(netns_path, sizeof(netns_path), "%s/%s", "/var/run/netns", "red");
    fprintf(stderr, "=> Setting network netspace to red...\n");
