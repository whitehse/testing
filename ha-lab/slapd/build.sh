...
../common/utils/install-packages.sh slapd-1 bird,bird-bgp,iputils-ping,gzip,wget,less,vim,vlan,slapd
...
../common/utils/install-packages.sh slapd-2 bird,bird-bgp,iputils-ping,gzip,wget,less,vim,vlan,slapd
