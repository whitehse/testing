...
sudo ovs-vsctl add-port switch-a router-b-1
...
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 100 100.64.0.9/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 101 100.64.0.13/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 102 100.64.0.17/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 103 100.64.0.21/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 104 100.64.0.25/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 105 100.64.0.29/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 106 100.64.0.33/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 107 100.64.0.37/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 108 100.64.0.41/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 109 100.64.0.45/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 110 100.64.0.49/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 111 100.64.0.53/30
../common/utils/set-primary-vlan-v4-address.sh router-a eth0 112 100.64.0.57/30

../common/utils/set-primary-vlan-v4-address.sh router-b eth0 200 100.64.0.61/30
../common/utils/set-primary-vlan-v4-address.sh router-b eth0 201 100.64.0.65/30
../common/utils/set-primary-vlan-v4-address.sh router-b eth0 202 100.64.0.69/30
../common/utils/set-primary-vlan-v4-address.sh router-b eth0 203 100.64.0.73/30
../common/utils/set-primary-vlan-v4-address.sh router-b eth0 204 100.64.0.77/30
../common/utils/set-primary-vlan-v4-address.sh router-b eth0 205 100.64.0.81/30
../common/utils/set-primary-vlan-v4-address.sh router-b eth0 206 100.64.0.85/30
../common/utils/set-primary-vlan-v4-address.sh router-b eth0 207 100.64.0.89/30
../common/utils/set-primary-vlan-v4-address.sh router-b eth0 208 100.64.0.93/30
../common/utils/set-primary-vlan-v4-address.sh router-b eth0 209 100.64.0.97/30
