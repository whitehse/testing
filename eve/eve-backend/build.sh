...
gcc -I. -o websockets.o websockets.c -c -I.
gcc -I. -o eve eve.c sodium.o curl.o unix_server.o iou.o websockets.o -lcurl -lassh -lev -luring -lsodium -lcbor -lcjson -L/usr/local/lib/ -lwebsockets
