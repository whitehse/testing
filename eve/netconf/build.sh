...
#gcc -I. -o netconf netconf.c -lev -lcbor -lcjson -lassh -lexpat -lpcre2-8 -L. -l:libnx_parse.a -l:libnx_xmlns_parse.a -g
gcc -I. -o netconf netconf.c nx_parse.o nx_xmlns_parse.o -lev -lcbor -lcjson -lassh -lexpat -lpcre2-8 -L. -l:libnx_parse.a -l:libnx_xmlns_parse.a -g
